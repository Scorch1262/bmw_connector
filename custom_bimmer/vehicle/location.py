...
from custom_bimmer.const import ATTR_ATTRIBUTES, ATTR_STATE, Regions
from custom_bimmer.coord_convert import gcj2wgs
from custom_bimmer.models import GPSPosition, VehicleDataBase
from custom_bimmer.utils import parse_datetime
...
class VehicleLocation(VehicleDataBase):
    ...
    """The last known address of the vehicle."""
    ...
    def _parse_vehicle_data(cls, vehicle_data: Dict):
        ...
        if ATTR_STATE in vehicle_data and "location" in vehicle_data[ATTR_STATE]:
            ...
            retval["address"] = location["address"]["formatted"]
        return retval
