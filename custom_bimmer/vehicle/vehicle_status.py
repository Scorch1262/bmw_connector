...
from custom_bimmer.models import GPSPosition, ValueWithUnit
from custom_bimmer.utils import deprecated

if TYPE_CHECKING:
    from custom_bimmer.vehicle import MyBMWVehicle
    from custom_bimmer.vehicle.doors_windows import Lid, LockState, Window
    from custom_bimmer.vehicle.fuel_and_battery import ChargingState
    from custom_bimmer.vehicle.reports import CheckControlMessage, ConditionBasedService
