...
from custom_bimmer.api.client import MyBMWClient
from custom_bimmer.const import (
    ATTR_ATTRIBUTES,
    ATTR_CAPABILITIES,
...
from custom_bimmer.models import StrEnum, ValueWithUnit
from custom_bimmer.utils import deprecated, parse_datetime
from custom_bimmer.vehicle.charging_profile import ChargingProfile
from custom_bimmer.vehicle.const import COMBUSTION_ENGINE_DRIVE_TRAINS, HV_BATTERY_DRIVE_TRAINS, DriveTrainType
from custom_bimmer.vehicle.doors_windows import DoorsAndWindows
from custom_bimmer.vehicle.fuel_and_battery import FuelAndBattery
from custom_bimmer.vehicle.location import VehicleLocation
from custom_bimmer.vehicle.remote_services import RemoteServices
from custom_bimmer.vehicle.reports import CheckControlMessageReport, ConditionBasedServiceReport
from custom_bimmer.vehicle.vehicle_status import VehicleStatus

if TYPE_CHECKING:
    from custom_bimmer.account import MyBMWAccount
    from custom_bimmer.models import VehicleDataBase
...
class MyBMWVehicle:
    ...
    @property
    def lastUpdatedAt(self) -> Optional[datetime.datetime]:
        """Get the timestamp when the data was updated from the vehicle."""
        return parse_datetime(str(self.data[ATTR_STATE].get("lastUpdatedAt")))
